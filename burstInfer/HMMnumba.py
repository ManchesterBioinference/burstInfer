...
@jit(nopython=True)
def v_m_function(K, trace_length, gammas_cleaned2, W, ms2_coeff_flipped,
                 count_reduction_manual, v_M_terms):
...
# =============================================================================
                ...
                v_M_terms = v_m_function(K, trace_length, gammas_cleaned2, W, ms2_coeff_flipped, count_reduction_manual, v_M_terms)

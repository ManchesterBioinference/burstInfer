# -*- coding: utf-8 -*-
"""
Created on Wed Sep  9 08:02:22 2020
...
# Basic configuration
seed_setter = 963456000 # Use specific seed for this demo
...
# This section replaces training with pre-learned parameters for demo purposes.
# 'learned_parameters' would be the normal output of the model.
# Delete this when using your own data! 
learned_parameters = {}
transitions = np.ones((2,2))
transitions[0,0] = 0.914861029765
transitions[1,0] = 0.0851389702354
transitions[1,1] = 0.875354906924
transitions[0,1] = 1 - 0.124645093076
...
learned_parameters['noise'] = 17142.7186506
learned_parameters['logL'] = -60449.4492842

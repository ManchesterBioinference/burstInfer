# -*- coding: utf-8 -*-
"""
Created on Fri Mar 27 21:21:47 2020
...
for i in np.arange(0, len(real_kon)):
    ...
    inner_list.append((scipy.linalg.logm(art_trans) / 20) * 19.60784)
...
export_df.to_csv('uwt_e1_mutant_comparison_xi_inter_TRC.csv')
pd.DataFrame(reconstituted_posterior).to_csv('uwt_e1_mutant_comparison_xi_inter_posterior_TRC.csv')
pd.DataFrame(reconstituted_signals).to_csv('uwt_e1_mutant_comparison_xi_inter_signals_TRC.csv')

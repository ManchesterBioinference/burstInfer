# -*- coding: utf-8 -*-
"""
Created on Mon May 17 22:10:29 2021
...
centre_df = pd.DataFrame(centre)
inter_df = pd.DataFrame(inter)
outer_df = pd.DataFrame(outer)
centre_df.to_csv('centre_traces.csv')
inter_df.to_csv('inter_traces.csv')
outer_df.to_csv('outer_traces.csv')
...
#export_posterior_df.to_csv('corrections_traces_centre.csv')
...
plt.title('SHORT GENE')
plt.xlim(0.6, 1)
plt.savefig('promoter_agreement.pdf', dpi=300)
plt.show()
...
#text(0.1, 0.9,'matplotlib', ha='center', va='center', transform=ax.transAxes)
plt.ylim(-100, 200)
plt.savefig('short_synthetic_fit_usable_long_very_high_noise.pdf', dpi=300)
plt.show()
...
plt.xticks(np.arange(0,35,5))
plt.yticks(np.arange(0, 2), labels=['OFF', 'ON'])
plt.savefig('short_synthetic_promoter_usable_long_very_high_noise.pdf', dpi=300)
plt.show()
...
plt.xlim(0.6, 1)
plt.savefig('promoter_agreement_usable_long_very_high_noise.pdf', dpi=300)
plt.show()